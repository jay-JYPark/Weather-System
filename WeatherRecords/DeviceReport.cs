...
{
    /// <summary>
    /// Summary description for DeviceReport.
    /// </summary>
    public partial class DeviceReport : DataDynamics.ActiveReports.ActiveReport3
    {
        /// <summary>
        /// 기본 생성자
        /// </summary>
        ...
        /// </param>
        /// 
        public DeviceReport(string title, string term, string deviceName, DataTable dTable)
        {
            InitializeComponent();
