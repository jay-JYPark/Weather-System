...
{
    /// <summary>
    /// Summary description for WaterlevelReport.
    /// </summary>
    public partial class WaterlevelReport : DataDynamics.ActiveReports.ActiveReport3
    {
        /// <summary>
        /// 기본 생성자
        /// </summary>
        public WaterlevelReport()
        {
            //
        ...
        /// </param>
        /// 
        public WaterlevelReport(string title, string term, string deviceName, string typeWeather, DataTable dTable)
        {
            InitializeComponent();
